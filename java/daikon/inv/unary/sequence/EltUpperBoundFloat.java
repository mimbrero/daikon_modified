...
public class EltUpperBoundFloat extends SingleFloatSequence {
  ...
  /**
   * Merge the invariants in invs to form a new invariant. Each must be a EltUpperBoundFloat invariant. This
