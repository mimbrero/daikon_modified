...
public final class EltOneOfFloat extends SingleFloatSequence implements OneOf {
  ...
  public String format_postman(@GuardSatisfied EltOneOfFloat this) {
    return "pm.expect(" + getPostmanVariableName(var().name()) + ".every(element => " + Arrays.toString(elts) + ".includes(element))).to.be.true";
  }
