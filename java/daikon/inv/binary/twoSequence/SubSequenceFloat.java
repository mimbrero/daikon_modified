...
public class SubSequenceFloat extends TwoSequenceFloat {
  ...
  public String format_postman(@GuardSatisfied SubSequenceFloat this) {
    String array1 = getPostmanVariableName(var1().name());
    String array2 = getPostmanVariableName(var2().name());
    return "pm.expect(" + array2 + ".slice(" + array2 + ".findIndex((element, index) => index >= " + array2 + ".indexOf(" + array1 + "[0]) && " + array1 + ".every((value, i) => value === " + array2 + "[index + i]))).includes(" + array1 + "[0])).to.be.true";
  }
  ...
  private String format_simplify_explicit(@GuardSatisfied SubSequenceFloat this) {
    ...
    String subseq_stmt =
      ...
      + "(EQ "
      + aE.replace(aI, "(+ " + aL + " " + index + ")") + " "
      + bE.replace(bI, "(+ (+ " + bL + " " + index + ") " + shift + ")") + ")))))";
